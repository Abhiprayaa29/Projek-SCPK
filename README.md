...
*   **`PemilihanKaryawan.py`**: Script utama Python yang memuat logika program dan algoritma pengambilan keputusan.
*   **`PemilihanKaryawan.ipynb`**: File Jupyter Notebook yang berisi baris kode step-by-step, sangat cocok untuk eksplorasi data dan presentasi alur logika secara visual.
*   **`SPK_Karyawan_WP.xlsx`**: File Excel yang memuat perhitungan manual/simulasi dari metode Weighted Product (WP) sebagai pembanding atau validasi terhadap hasil dari program Python.
